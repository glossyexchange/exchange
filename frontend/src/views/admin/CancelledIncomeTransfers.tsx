...
const CancelledIncomeTransfers: React.FC = () => {
  ...
  const fetchCancelledIncomeTransfers = useCallback(() => {
    setLoading(true);
    return dispatch(
      getCancelledIncomeTransfers({
        parPage,
  ...
  const handleDeleteIncomeTransfer = (voucherNo: number) => {
    const incomeTransferToDelete = cancelledIncomeTransfers.find(
      ...
      dispatch(
        deleteCancelledIncomeTransfer({
          ...
          fiscalYear: incomeTransferToDelete.fiscalYear,
                  deleteCancelledIncomeTransfer: incomeTransferToDelete,
        }),
      );
    });
  };
      ...
      <div className="px-2 pb-5 lg:px-4">
        <div className="flex items-center justify-between pb-3">
          <h2 className="text-lg font-medium text-[#5c5a5a] ">
            {t("dashboard.Cancelled Income Transfers")}
          </h2>{" "}
          <span className="px-2">
            {totalCancelledTransfers} {t("sendTransfer.cancelled_income")}
          </span>
        </div>
        <div className="w-full rounded-md bg-[#ffffff] p-4 shadow-md">
          ...
          {loading ? (
          ...
          ) : cancelledIncomeTransfers?.length === 0 ? (
            ...
            >
              ...
              >
                ...
                <tbody>
                  {cancelledIncomeTransfers?.map((o, i) => (
                    <tr
                      key={i}
                      ...
                      <td className="whitespace-nowrap px-4  py-2">
                        <div className="flex items-center justify-end gap-3">
                          <button
                            onClick={() => {
                              ...
                              localStorage.setItem(
                               ...
                               navigate(`/admin/dashboard/income-transfers?cancelledIncomeType=1`, {
                                state: {
                          ...
                          {/* <Link
                            to={
                              {
                                pathname: `/admin/dashboard/income-transfers/${o.voucherNo}`,
                                search: "?cancelledIncomeType=1",
                                state: {
                                  isRestoringCancelledTransfer: true,
                                  cancelledTransferData: o,
                                },
                          ...
                          {/* <Link
                            to={`/admin/dashboard/income-transfers/${o.voucherNo}?cancelledIncomeType=1`}
                            className={`rounded bg-green-600 px-[8px] py-[6px] text-sm text-white hover:shadow-lg hover:shadow-[#2a629aab]`}
                          >
                            {" "}
                            <FaUndo />
...
export default CancelledIncomeTransfers;
